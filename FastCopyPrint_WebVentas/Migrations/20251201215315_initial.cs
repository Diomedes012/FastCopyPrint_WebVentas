        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoVenta = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListasDeseos", x => x.ListaDeseoId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListasDeseos_Productos_ProductoId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1_stamp_estatico", "Encargado", "ENCARGADO" },
                    { "2", "2_stamp_estatico", "Cliente", "CLIENTE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListasDeseos_ProductoId",
                table: "ListasDeseos",
                column: "ProductoId");
